...
public class PaymentMethods extends Base {
	...
	public void openBrowser() throws Exception{
		try{
		    ...
		    ScreenCapture.ActiveSnapShot("1. Browser Successfuly Launched ", this.getClass().getSimpleName());
		}
		catch (Exception e) {
			e.printStackTrace();
		}
	...
	@Test
	public void TSS_PaymentMethods() throws Exception{
	    ...
	    Thread.sleep(5000);
	    driver.findElement(By.xpath("//span[.='Payment Methods']")).click();
	    Thread.sleep(3000);
	    driver.findElement(By.xpath("//div[@class='walletdesc']/h4[.='PayU']")).click();
	    test.log(LogStatus.INFO, "Testcase Payment Method complited successfull");
	}
